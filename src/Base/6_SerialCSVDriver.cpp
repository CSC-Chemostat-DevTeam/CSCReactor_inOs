...
void SerialCSVDriver::openMsgResponse()
{
    ...
    SerialCSVDriver::sendMsgEcho();
}

void SerialCSVDriver::sendMsgEcho()
{
    SerialCSVDriver::sendMsg(
        MSG_ECHO_TOKEN,
        SerialCSVDriver::linehash(),
        SerialCSVDriver::timetag(),
        SerialCSVDriver::msgCsvLineString(true));
}
...
String SerialCSVDriver::msgCsvLineString(boolean trim)
{
    return SerialCSVDriver::csvline.csvLineString(trim);
}
